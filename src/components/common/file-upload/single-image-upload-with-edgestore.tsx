...
const ImageUpload: React.FC<ImageUploadProps> = ({
    ...
    const [uploadedImages, setUploadedImages] = useState<string[]>(value || []); // Store images (can be single or multiple)
    ...
    const { onClick, onDragOver, onDrop: rootOnDrop } = getRootProps();
